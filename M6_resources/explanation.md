...
၂။ တစ်ခါတည်း အတုံးအခဲ ရနိုင်လား။
...
### ဥပမာ
အောက်မှာ code က `mime_type` ကွဲပြားပြီး resource တွေ ဘယ်လိုပြန်လဲ ပြပါတယ်။ ကျွန်တော်တို့ ကြည့်ရမှာက — return လုပ်တဲ့ ပုံစံအလိုက် content type ဘယ်လို ပြောင်းသွားလဲ ဆိုတာပါ။
```python
import json
...
- Path confinement ရဲ့ အလွှာ ၂ ခု (URI router + `Path.resolve()` containment) ကို ဒီ module မှာ မိတ်ဆက်ပြီး M10 မှာ အပြည့်အစုံ သင်ပါမယ်။