...
- register ဖြစ်ထားသည့် tool များ၏ အရေအတွက်ကို ရေတွက်ခြင်း
...
**Expected behavior:** Script run လိုက်ရင် server နာမည်၊ tool အရေအတွက်နှင့် tool နာမည်များ ထွက်လာပြီး ဘယ် tool မှ ပျောက်နေတာ မရှိပါ။
...
**Expected behavior:** Server တစ်ခုတည်းကို stdio နှင့် HTTP transport နှစ်မျိုးလုံးဖြင့် အောင်မြင်စွာ ခေါ်ဆိုနိုင်ပြီး ဘယ်လိုလုပ်ငန်းကိုမဆို ဘယ် transport က သင့်တော်သလဲ ဆုံးဖြတ်နိုင်သည့် အသိ ရရှိပါတယ်။
