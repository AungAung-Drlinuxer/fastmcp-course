...
ဥပမာ — ဆိုင်ကို ဆိုင်ရှင်ကို "မရှိဘူး" လို့ ပြန်ပြောတာ (return) နဲ့ ဆိုင်ပတ်က အော်တာ (raise) လိုမျိုး ကွဲပြားတယ်။
...
Type rules (အမျိုးအစား စည်းမျဉ်း) ကိုတော့ Pydantic က စစ်ပေးပြီးသားပါ။ Domain rules (စနစ်ရဲ့ စည်းမျဉ်း — ဥပမာ ကိန်းလား၊ ဘယ်လောက်အရွယ်အတွက် ဘယ်လောက် အဆင့်သင့်လား) ကိုပဲ ကိုယ်တိုင် စစ်ရနေတုန်းပါ။ နယ်နိမိတ်မှာပဲ တားဆီးတဲ့ boundary defense ကြောင့် ကုဒ် ပိုတိုသွားပါတယ်။
